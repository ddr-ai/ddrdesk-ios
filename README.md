...
| Pointer | **UIKit trackpad overlay** | One-finger drag = relative move, tap = left click, quick double-tap = right click. Hold 1.5s then drag = text select; release = copy. |
...
4. Drag one finger to move the pointer; tap to left-click; quick double-tap to right-click. Hold **1.5 seconds**, then drag to highlight text; lift to copy (Ctrl+C).
